...
- **仓库**: [tencent-ai/codebuddy-code](https://www.npmjs.com/package/@tencent-ai/codebuddy-code)
...
#### 🗺️ geo
- **主页**: [MetaCubeX/geo](https://github.com/MetaCubeX/geo)
...
- **仓库**: [@lazycatcloud/lzc-cli](https://www.npmjs.com/package/@lazycatcloud/lzc-cli)
- **简介**: Lazycat 硬件客户端工具
...
#### 🔧 uutils-selected
- **主页**: [uutils coreutils](https://github.com/uutils/coreutils)
...
- **主页**: [Canon 支持](https://hk.canon/en/support)
- **仓库**: N/A
...
*维护者: [Moonfruit](https://github.com/moonfruit)*
